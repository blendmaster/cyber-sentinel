 ...
 * @author Isaac
 */
public class HybridInteractionGraphVertex  extends ClassBasedVertexFactory implements Comparable<HybridInteractionGraphVertex>, Serializable{
    private User user;
    ...
    @Override
    public int compareTo(HybridInteractionGraphVertex o) {
